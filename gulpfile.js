...
function gridstack(done) {
    gulp.src(paths.npm + '/gridstack/dist/gridstack.min.css').pipe(
        gulp.dest('src/assets/css/')
    );
    gulp.src(paths.npm + '/gridstack/dist/gridstack.jQueryUI.min.js').pipe(
        gulp.dest('src/assets/js/')
    );
    gulp.src(paths.npm + '/gridstack/dist/gridstack.min.js').pipe(
        gulp.dest('src/assets/js/')
    );
    gulp.src(paths.npm + '/gridstack/dist/gridstack.min.map').pipe(
        gulp.dest('src/assets/js/')
    );
